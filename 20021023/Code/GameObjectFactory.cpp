...
std::shared_ptr<GameObject> GameObjectFactory::CreateGameObject_Level3Manager(std::shared_ptr<ComponentRegistry> component_registry) {
	...
	level3manager->level_finished_despawn_player_time = 20;
	level3manager->level_finished_despawn_commander_frame_time = 22;
	level3manager->level_finished_fade_out_time = 22;
	level3manager->level_finished_length = 27;
